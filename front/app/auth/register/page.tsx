...
export default function RegisterPage() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-gray-100 to-zinc-200 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
